...
from .ai import fix, maybe_execute, nav, render_result
...
from .logging_utils import fail, warn
...
def build_parser() -> argparse.ArgumentParser:
    ...
    nav_parser.add_argument("request", nargs="+")
    add_common_flags(nav_parser, json_flag=True, execute_flag=True)
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if args.command == "nav":
            ...
            result = nav(paths, config, request)
